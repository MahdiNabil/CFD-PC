...
{
    defineTypeNameAndDebug(HiLoFacePair, 0);
    addToRunTimeSelectionTable(thermalPhaseChangeModel, HiLoFacePair, dictionary);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::thermalPhaseChangeModels::HiLoFacePair::HiLoFacePair
(
		const word& name,
...
void Foam::thermalPhaseChangeModels::HiLoFacePair::calcQ_pc()
{
...
bool Foam::thermalPhaseChangeModels::HiLoFacePair::read(const dictionary& thermalPhaseChangeProperties)
{
