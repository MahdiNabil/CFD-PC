...
int main(int argc, char *argv[])
{
    ...
    while (runTime.run())
    {
		...
		phaseChangeModel1->correct();
		phaseChangeModel2->correct();
		phaseChangeModel3->correct();
		phaseChangeModel4->correct();
		phaseChangeModel5->correct();
		...
		Info<< "****Phase change energy: " << gSum( phaseChangeModel1->Q_pc()*mesh.V() ) << " W" << endl;
		Info<< "****Phase change energy: " << gSum( phaseChangeModel2->Q_pc()*mesh.V() ) << " W" << endl;
		Info<< "****Phase change energy: " << gSum( phaseChangeModel3->Q_pc()*mesh.V() ) << " W" << endl;
		Info<< "****Phase change energy: " << gSum( phaseChangeModel4->Q_pc()*mesh.V() ) << " W" << endl;
		Info<< "****Phase change energy: " << gSum( phaseChangeModel5->Q_pc()*mesh.V() ) << " W" << endl;
		Info<< "****Volume change: " << gSum( phaseChangeModel1->PCV() * mesh.V() ) << " m^3/s" << endl;
		Info<< "****Volume change: " << gSum( phaseChangeModel2->PCV() * mesh.V() ) << " m^3/s" << endl;
		Info<< "****Volume change: " << gSum( phaseChangeModel3->PCV() * mesh.V() ) << " m^3/s" << endl;
		Info<< "****Volume change: " << gSum( phaseChangeModel4->PCV() * mesh.V() ) << " m^3/s" << endl;
		Info<< "****Volume change: " << gSum( phaseChangeModel5->PCV() * mesh.V() ) << " m^3/s" << endl;
