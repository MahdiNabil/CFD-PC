...
{
    defineTypeNameAndDebug(HiLoBetaPCV, 0);
    addToRunTimeSelectionTable(thermalPhaseChangeModel, HiLoBetaPCV, dictionary);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::thermalPhaseChangeModels::HiLoBetaPCV::HiLoBetaPCV
(
		const word& name,
...
void Foam::thermalPhaseChangeModels::HiLoBetaPCV::calcQ_pc()
{
...
bool Foam::thermalPhaseChangeModels::HiLoBetaPCV::read(const dictionary& thermalPhaseChangeProperties)
{
