...
)
{
    ...
    const fixedWallHeatFluxFvPatchScalarField& fgptf =
        refCast<const fixedWallHeatFluxFvPatchScalarField>(ptf);

    gradient_.rmap(fgptf.gradient_, addr);
}


void fixedWallHeatFluxFvPatchScalarField::evaluate(const Pstream::commsTypes)
{
    if (!this->updated())
    {
        this->updateCoeffs();
...
tmp<scalarField> fixedWallHeatFluxFvPatchScalarField::valueInternalCoeffs
(
...
tmp<scalarField> fixedWallHeatFluxFvPatchScalarField::valueBoundaryCoeffs
(
    const tmp<scalarField>&
) const
{
...
tmp<scalarField> fixedWallHeatFluxFvPatchScalarField::
