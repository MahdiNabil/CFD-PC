...
define(hX, 13.182E-6);         //Normal direction resolution
define(hXB, 4.394E-5);		//Normal direction resolution in the bulk
define(hY, 4.394E-5);           //Length-direction resolution
